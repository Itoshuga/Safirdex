...
export const metadata: Metadata = {
  title: "Connexion et inscription | Safirdex",
  description: "Créez votre compte Safirdex et gérez votre collection Safir.",
    ...
    <main className="relative min-h-screen overflow-hidden bg-background">
      ...
      <header className="relative z-10 mx-auto flex h-20 max-w-[90rem] items-center justify-between border-b border-border/55 px-5 sm:px-8 lg:px-12">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <ArrowLeft className="size-3.5" /> Retour au Codex
          </Link>
          <ThemeToggle />
        </div>
      </header>
      ...
      <div className="relative z-10 mx-auto grid min-h-[calc(100svh-5rem)] w-full max-w-7xl items-center gap-14 px-5 py-10 sm:px-8 lg:grid-cols-[1fr_31rem] lg:px-12 lg:py-16">
        <section className="hidden max-w-xl lg:block">
          <p className="mb-5 flex items-center gap-2.5 text-xs font-semibold tracking-[0.1em] text-safir uppercase">
            <span className="size-1.5 bg-safir" /> Ton espace personnel
          </p>
          ...
          <p className="mt-6 max-w-lg text-base leading-7 text-muted-foreground">
            Crée ton compte pour construire ta collection Safir, identifier les
            cartes manquantes et conserver ta progression dans le temps.
          </p>
          <div className="mt-10 grid grid-cols-3 border-y">
            {[
              [Bookmark, "Collection", "Garde la trace de chaque carte."],
              [Search, "Recherche", "Retrouve rapidement les manquantes."],
              [Cloud, "Synchronisation", "Accède à ta liste partout."],
